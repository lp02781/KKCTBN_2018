...
if("TRUE" STREQUAL "TRUE")
  set(whatever_SOURCE_PREFIX /home/mfikih15/KKCTBN_2018/src/whatever)
  set(whatever_DEVEL_PREFIX /home/mfikih15/KKCTBN_2018/devel)
  set(whatever_INSTALL_PREFIX "")
  set(whatever_PREFIX ${whatever_DEVEL_PREFIX})
else()
  set(whatever_SOURCE_PREFIX "")
  set(whatever_DEVEL_PREFIX "")
  set(whatever_INSTALL_PREFIX /home/mfikih15/KKCTBN_2018/install)
...
if(NOT "/home/mfikih15/KKCTBN_2018/devel/include " STREQUAL " ")
  set(whatever_INCLUDE_DIRS "")
  set(_include_dirs "/home/mfikih15/KKCTBN_2018/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'whatever' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mfikih15/KKCTBN_2018/src/whatever/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT whatever_NUM_DUMMY_TARGETS)
      set(whatever_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::whatever::wrapped-linker-option${whatever_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR whatever_NUM_DUMMY_TARGETS "${whatever_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::whatever::wrapped-linker-option${whatever_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND whatever_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mfikih15/KKCTBN_2018/devel/lib;/home/mfikih15/rover_robotics/devel/lib;/home/mfikih15/obslam_vehicle/devel/lib;/opt/ros/melodic/lib)
