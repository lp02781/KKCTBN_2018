...
if(NOT "/home/amvui/AMV/devel/include " STREQUAL " ")
  set(whatever_INCLUDE_DIRS "")
  set(_include_dirs "/home/amvui/AMV/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'whatever' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amvui/AMV/src/whatever/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amvui/AMV/devel/lib;/home/amvui/AMV/devel/lib;/home/amvui/lala/devel/lib;/opt/ros/kinetic/lib)
