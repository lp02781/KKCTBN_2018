...
set(MSG_I_FLAGS "-Iwhatever:/home/mfikih15/KKCTBN_2018/src/whatever/msg;-Imavros_msgs:/opt/ros/melodic/share/mavros_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Igeographic_msgs:/opt/ros/melodic/share/geographic_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Iuuid_msgs:/opt/ros/melodic/share/uuid_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/flight_mode.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/flight_mode.msg" ""
)

get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/override_motor.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/override_motor.msg" ""
)

get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/node_master.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/node_master.msg" ""
)

get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/image_process.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/image_process.msg" ""
)

get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/setpoint.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/setpoint.msg" ""
)

get_filename_component(_filename "/home/mfikih15/KKCTBN_2018/src/whatever/msg/rc_number.msg" NAME_WE)
add_custom_target(_whatever_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "whatever" "/home/mfikih15/KKCTBN_2018/src/whatever/msg/rc_number.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/whatever)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/whatever\")")
  # install generated code
  install(
